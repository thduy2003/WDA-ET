...
const Comment = ({pos}) => {
    ...
    page == 1 ? CommentDataList = CommentData.slice(0,5) : CommentDataList = CommentData.slice(5,9) 
    console.log(page)
    return (
        <div>
            <div>
           ...
           <div className="flex justify-center items-center gap-2">
                ...
                <Button type={"primary"} size={"small"}  onClick={() => setPage(1)}>1</Button>
                <Button type={"outline-red"} size={"small"} onClick={() => setPage(2)} >2</Button>
