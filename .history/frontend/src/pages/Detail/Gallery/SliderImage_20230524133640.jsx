        ...
        <div className="w-full h-screen bg-black absolute flex justify-center items-center">
            ...
            <div className="text-[20px] leading-[28px] text-white font-semibold mb-4"> Các hình ảnh liên quan </div>
                <div className="w-[900px] h-[540px]">
                    <img className="w-full h-full object-cover" src={RelatedImageData[indexImage].source}></img>
                </div>
                <div className="flex gap-3">
                    {RelatedImageData.map((n,i) => <div key={i} onClick={()=>setIndex(i)} className={`cursor-pointer ${i==indexImage ? 'opacity-100' :'opacity-30'}`}> 
            ...
            <div className="absolute top-100 right-[230px] cursor-pointer bg-white rounded-[50%]" onClick={indexImage => console.log(indexImage+1)}>
            <ArrowRight2
                size="40"
                color="black"
                />
            </div>
            <div className="absolute top-100 left-[230px] cursor-pointer bg-white rounded-[50%]" onClick={index => setIndex(index - 1)}>
            <ArrowLeft2
                size="40"
                color="black"
                />
