    ...
    return (
        ...
        <div className="flex align-center justify-center">
            <div className="flex bg-gray-200 w-[90%] mt-14">
                ...
                <div className="w-[75%]">
                    <div>  
                    <div className="text-[28px] leading-[36px] text-[#141716] font-semibold mb-6">  Tổng quan 
                    </div>
                    <div className="text-[28px] leading-[36px] text-[#141716] font-semibold mb-6">Nằm ở vị trí tiếp giáp với Thành phố Hồ Chí Minh và thuộc khu vực đồng bằng sông Cửu Long, Long An đã trở thành cửa ngõ quan trọng để giao thương kinh tế cho các tỉnh miền Tây. Trước đây, vùng đất này từng là địa bàn quan trọng của vương quốc Phù Nam - Chân Lạp, thuộc Gia Định. 
