        ...
        <div className="flex align-center justify-center">
            <div className="flex bg-gray-200 w-[90%] mt-14">
                ...
                <div className="w-[75%]">
                    ...
                    Với vị trí thuận lợi như thế, dần dần các địa điểm du lịch Long An cũng được đến gần hơn với nhiều du khách. Đặc biệt là không khí bình yên dân dã đậm chất miền Tây ở ngay kế bên Sài Gòn này đã trở thành nơi xả stress cuối tuần thú vị cho dân Sài thành.                        </div>
