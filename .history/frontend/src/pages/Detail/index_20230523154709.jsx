...
import { Archive, Layer } from 'iconsax-react';
const Detail = ({position = "Long An"}) => {
    return (
        // container
        <div className="flex align-center justify-center">
            <div className="flex justify-between gap-14 bg-gray-200 w-[90%] mt-14">
                {/* Main */}
                <div className="w-[75%]">
                    <div>  
                ...
                <div className="w-[30%] max-w-[361px]">
                    ...
                    <div className="">
                        <div className="">Thông tin chung </div>
                        <div className="">
                            <div className="">
                                <Layer size="20" color="#D02F3D" variant="Bold"></Layer>
                            ...
                            <div className="">
                                <Layer size="20" color="#D02F3D" variant="Bold"></Layer>
                                <p>Địa danh tham quan: 650.000 người</p>
                            </div>
                        </div>
                    </div>
                </div>
