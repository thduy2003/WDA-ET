            ...
            <div className="grid grid-cols-3 gap-1 relative">
                {
                    imagesData.map((n, i) => i < 6 ? <div key={i} onClick={onZoom}>
                        <img src={`https://viewander-backend-zwn8.onrender.com/public/images/landmarks/${n}`} className={`w-[102px] h-[87px] object-cover rounded-md cursor-pointer ${i == 5 ? `opacity-40` : ""}`}></img>
                    </div> : "")
                }
