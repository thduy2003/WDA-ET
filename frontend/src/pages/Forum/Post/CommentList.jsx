...
const CommentList = ({ choosedPost }) => {
    ...
    return (
        <div className="mt-5 z-10 absolute max-sm:w-full">
            <div className="flex flex-col gap-4 p-9 shadow-lg rounded-[8px] bg-white max-sm:w-full md:w-[811px] md:translate-x-[45%]">
